...
namespace Server.Gumps
{
    public class ImbuingGumpB : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddPage(0);
            AddBackground(0, 0, 520, 520, 9350);
            ...
            AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10001, GumpButtonType.Reply, 0);
            ...
            {
                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10002, GumpButtonType.Reply, 0);
            ...
            {
                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10006, GumpButtonType.Reply, 0);
                AddHtmlLocalized(50, 90 + (yOffset * 25), 150, 18, 1114250, LabelColor, false, false);   //Hit Area Effects
                yOffset += 1;

                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10007, GumpButtonType.Reply, 0);
                AddHtmlLocalized(50, 90 + (yOffset * 25), 150, 18, 1114251, LabelColor, false, false);   //Hit Effects
                yOffset += 1;
            }

            AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10003, GumpButtonType.Reply, 0);
            AddHtmlLocalized(50, 90 + (yOffset * 25), 150, 18, 1114252, LabelColor, false, false);       //Misc.
            yOffset += 1;

            if (itemRef == 2)
            {
                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10015, GumpButtonType.Reply, 0);
            ...
            {
                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10004, GumpButtonType.Reply, 0);
            ...
            if (itemRef == 1 || itemRef == 2)
            {
                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10008, GumpButtonType.Reply, 0);
                AddHtmlLocalized(50, 90 + (yOffset * 25), 150, 18, 1114263, LabelColor, false, false);   //Slayers
                yOffset += 1;

                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10009, GumpButtonType.Reply, 0);
            ...
            if (itemRef == 6)
            {
                for (int i = 0; i < 5; i++)
                {
                    AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10010 + i, GumpButtonType.Reply, 0);
            ...
            {
                AddButton(15, 90 + (yOffset * 25), 30533, 30534, 10005, GumpButtonType.Reply, 0);
            ...
            if (menuCat == 1) // == CASTING ==
            {
                if (itemRef == 1 || itemRef == 2)
                {
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10122, GumpButtonType.Reply, 0);
                    AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1079766, LabelColor, false, false);       //Spell Channeling
                    yOffset += 1;

                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10141, GumpButtonType.Reply, 0);
                ...
                {
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10118, GumpButtonType.Reply, 0);
                    AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1075625, LabelColor, false, false);       //Lower Reg Cost
                    yOffset += 1;

                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10117, GumpButtonType.Reply, 0);
                ...
                {
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10114, GumpButtonType.Reply, 0);
                    ...
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10115, GumpButtonType.Reply, 0);
            ...
            else if (menuCat == 3)  // == MISC ==
            {
                if (itemRef == 1 || itemRef == 2)
                {
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10121, GumpButtonType.Reply, 0);
                    AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1061153, LabelColor, false, false);       //Luck
                    yOffset += 1;
                }
                else if (itemRef == 3 || itemRef == 5)
                {
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10119, GumpButtonType.Reply, 0);
                    AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1075626, LabelColor, false, false);       //Reflect Physical Damage
                    yOffset += 1;

                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10123, GumpButtonType.Reply, 0);
                ...
                else if (itemRef == 4)
                {
                    ...
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10124, GumpButtonType.Reply, 0);
                    AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1079757, LabelColor, false, false);       //Lower Requirements
                    yOffset += 1;

                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10142, GumpButtonType.Reply, 0);
                ...
                else if (itemRef == 6)
                {
                    ...
                    AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10120, GumpButtonType.Reply, 0);
            ...
            else if (menuCat == 15)  // == Ranged ==
            {
                if (itemRef == 2)
                {
                    if (twoHanded)
                    {
                        AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10160, GumpButtonType.Reply, 0);
            ...
            else if (menuCat == 14)  // == SKILL GROUP 5 ==
            {
                ...
                AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10278, GumpButtonType.Reply, 0);
                AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1044086, LabelColor, false, false);           //Resist Spells
                yOffset += 1;

                AddButton(250, 90 + (yOffset * 20), 30533, 30534, 10279, GumpButtonType.Reply, 0);
                AddHtmlLocalized(295, 90 + (yOffset * 20), 150, 18, 1044077, LabelColor, false, false);          //Healing
                yOffset += 1;
            }

            AddButton(15, 490, 30535, 30535, 1, GumpButtonType.Reply, 0);
