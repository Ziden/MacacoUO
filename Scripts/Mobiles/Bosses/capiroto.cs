...
namespace Server.Mobiles
{
    public class capiroto : BaseChampion
    {
        ...
        public void Terremoto(Mobile alvo)
        {
            ...
            pentagrama.PublicOverheadMessage(Network.MessageType.Regular, 0, true, "* Rocha da Maldição *");
        ...
        public override void OnThink()
        {
            ...
            if (pl != null)
            {
                ...
                if (Hue == 2075 && !IsCooldown("Diabos") && pl.GetDistanceToSqrt(this) <= 10)
                {
                    SetCooldown("Diabos", TimeSpan.FromSeconds(10));
                    ...
                    this.PublicOverheadMessage(Network.MessageType.Emote, 0, true, "* Joga uma pedra *");
            ...
            : base(AIType.AI_Melee)
        {
            ...
            SetDamageType(ResistanceType.Fire, 400);
            SetDamageType(ResistanceType.Energy, 25);

            SetResistance(ResistanceType.Physical, 80, 90);
            SetResistance(ResistanceType.Fire, 180, 200);
        ...
        public override void OnDeath(Container c)
        {
            base.OnDeath(c);
            {
                ...
                itemFoda.Hue = 2075;
                itemFoda.Attributes.WeaponDamage = 10;
                itemFoda.Attributes.SpellDamage = 9;
                itemFoda.Name = "Manto do Inferno";
            ...
            DistribuiItem(new CristalTherathan(15));
