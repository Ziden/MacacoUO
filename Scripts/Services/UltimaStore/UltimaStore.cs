...
namespace Server.Engines.UOStore
{
    ...
    public static class UltimaStore
    {
        ...
        public static void Initialize()
        {
            ...
            Register<EtherealRidgeback>(new TextDefinition("Ridgeback Magico"), "Item pertence pessoal que nao se perde ao morrer. <br>Pode ser usado a qualquer momento para invocar um cavalo magico.<br>Pode ser usado para sempre.<br>Nao consome slots de animais<br>Intransferivel", 0x2615, 0, 0, 15000, cat);
            Register<EtherealBoura>(new TextDefinition("Boura Magico"), "Item pertence pessoal que nao se perde ao morrer. <br>Pode ser usado a qualquer momento para invocar um cavalo magico.<br>Pode ser usado para sempre.<br>Nao consome slots de animais<br>Intransferivel", 0x46F8, 0, 0, 15000, cat);
