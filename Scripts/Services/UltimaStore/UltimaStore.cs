...
namespace Server.Engines.UOStore
{
    ...
    public static class UltimaStore
    {
        ...
        public static void Initialize()
        {
            ...
            Register<TrinsicKeepDeed>("Keep Trinsic", "Deed de Moradia Keep 3 andares .<br>Moradia chique para lords.", 0x14F0, 0, 0, 5000, cat);
       ...
       */
        ...
        private static void Register<T>(string v)
        {
